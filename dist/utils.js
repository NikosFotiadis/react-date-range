...
function calcFocusDate(currentFocusedDate, props) {
  ...
  targetInterval.start = (0, _dateUtils.startOfMonth)(targetInterval.start || new Date());
  targetInterval.end = (0, _dateUtils.endOfMonth)(targetInterval.end || targetInterval.start);
  ...
  var currentFocusInterval = {
    start: (0, _dateUtils.startOfMonth)(currentFocusedDate),
    end: (0, _dateUtils.endOfMonth)((0, _dateUtils.addMonths)(currentFocusedDate, months - 1))
  };
  if ((0, _dateUtils.areIntervalsOverlapping)(targetInterval, currentFocusInterval)) {
...
function getMonthDisplayRange(date, dateOptions) {
  var startDateOfMonth = (0, _dateUtils.startOfMonth)(date, dateOptions);
  var endDateOfMonth = (0, _dateUtils.endOfMonth)(date, dateOptions);
  var startDateOfCalendar = (0, _dateUtils.startOfWeek)(startDateOfMonth, dateOptions);
  var endDateOfCalendar = (0, _dateUtils.endOfWeek)(endDateOfMonth, dateOptions);
  return {
