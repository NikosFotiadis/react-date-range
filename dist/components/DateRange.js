...
var DateRange = function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    _dateUtils.timezoneManager.setTimezone(props.timezone);
  ...
  _createClass(DateRange, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps.timezone !== this.props.timezone) {
        _dateUtils.timezoneManager.setTimezone(this.props.timezone);
      }
    }
  }, {
    ...
    value: function calcNewSelection(value) {
      ...
      if (!isSingleValue) {
        ...
        // startDate selection
        var dayOffset = (0, _dateUtils.differenceInCalendarDays)(endDate, startDate);
        startDate = value;
        endDate = moveRangeOnFirstSelection ? (0, _dateUtils.addDays)(value, dayOffset) : value;
        if (maxDate) endDate = (0, _dateUtils.min)([endDate, maxDate]);
      ...
      var inValidDatesWithinRange = disabledDates.filter(function (disabledDate) {
        return (0, _dateUtils.isWithinInterval)(disabledDate, {
          start: startDate,
          end: endDate
        });
      });
      ...
      if (inValidDatesWithinRange.length > 0) {
        if (isStartDateSelected) {
          startDate = (0, _dateUtils.addDays)((0, _dateUtils.max)(inValidDatesWithinRange), 1);
        } else {
          endDate = (0, _dateUtils.addDays)((0, _dateUtils.min)(inValidDatesWithinRange), -1);
        }
      }
