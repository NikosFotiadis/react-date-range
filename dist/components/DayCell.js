...
var DayCell = function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function renderPreviewPlaceholder() {
      ...
      var startDate = preview.startDate ? (0, _dateUtils.endOfDay)(preview.startDate) : null;
      var endDate = preview.endDate ? (0, _dateUtils.startOfDay)(preview.endDate) : null;
      var isInRange = (!startDate || (0, _dateUtils.isAfter)(day, startDate)) && (!endDate || (0, _dateUtils.isBefore)(day, endDate));
      var isStartEdge = !isInRange && (0, _dateUtils.isSameDay)(day, startDate);
      var isEndEdge = !isInRange && (0, _dateUtils.isSameDay)(day, endDate);
    ...
    value: function renderSelectionPlaceholders() {
      ...
      if (this.props.displayMode === 'date') {
        var isSelected = (0, _dateUtils.isSameDay)(this.props.day, this.props.date);
      ...
      var inRanges = ranges.reduce(function (result, range) {
        ...
        if (startDate && endDate && (0, _dateUtils.isBefore)(endDate, startDate)) {
          var _ref = [endDate, startDate];
          startDate = _ref[0];
          endDate = _ref[1];
        }
        startDate = startDate ? (0, _dateUtils.endOfDay)(startDate) : null;
        endDate = endDate ? (0, _dateUtils.startOfDay)(endDate) : null;
        var isInRange = (!startDate || (0, _dateUtils.isAfter)(day, startDate)) && (!endDate || (0, _dateUtils.isBefore)(day, endDate));
        var isStartEdge = !isInRange && (0, _dateUtils.isSameDay)(day, startDate);
        var isEndEdge = !isInRange && (0, _dateUtils.isSameDay)(day, endDate);
      ...
      return inRanges.map(function (range, i) {
        ...
        return _react2.default.createElement('span', {
          ...
          style: {
            color: range.color || _this2.props.color
          }
        });
      });
    }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            null,
            (0, _dateUtils.format)(this.props.day, 'D')
          )
        )
      );
    }
